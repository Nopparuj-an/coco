...
coco - program to do something

# SYNOPSIS

**coco** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**coco** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **coco** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**coco** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    coco. See **foo.conf**(5) for further details.
...
**coco** provides some return codes, that can be used in scripts:
...
Nopparuj <nopparuj.an@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Nopparuj
